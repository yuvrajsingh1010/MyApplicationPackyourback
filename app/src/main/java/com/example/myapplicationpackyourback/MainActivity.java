...
import com.example.myapplicationpackyourback.Adapter.Adapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        if(mBackPressed + TIME_INTERVAL >System.currentTimeMillis()){
            ...
            Toast.makeText(this,"Tap Back Button in order exit",Toast.LENGTH_SHORT).show();
        }
