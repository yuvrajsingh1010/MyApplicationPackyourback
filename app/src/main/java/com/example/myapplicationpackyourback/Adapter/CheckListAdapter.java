package com.example.myapplicationpackyourback.Adapter;
...
import com.example.myapplicationpackyourback.R;
    ...
    public void onBindViewHolder(@NonNull CheckListViewHolder holder, int position) {
        ...
        if(MyConstants.FALSE_STRING.equals(show)){
            ...
            if(itemsList.get(position).getChecked()){
                ...
                holder.layout.setBackgroundDrawable(context.getDrawable(R.drawable.border_one));
